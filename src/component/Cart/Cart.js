  ...
  return (
    <div>
      <div>
        <h4>Add a Break</h4>
        <div className="time">
          <button onClick={() => handleAddBreak("10")} class="btn-time">
            10m
          </button>
          <button onClick={() => handleAddBreak("20")} class="btn-time">
            20m
          </button>
          <button onClick={() => handleAddBreak("30")} class="btn-time">
            30m
          </button>
          <button onClick={() => handleAddBreak("40")} class="btn-time">
            40m
          </button>
        </div>
      </div>
      ...
      <div>
        <button className="btn-last">Activity Completed</button>
      </div>
